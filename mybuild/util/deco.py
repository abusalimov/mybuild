...
from mybuild._compat import _create_temp_meta
...
def constructor_decorator(*bases, **kwargs):
    ...
    #
    # This magic is similar to the one used in mybuild._compat.extend function.
    deco_metaclass = _create_temp_meta(*bases, **kwargs)
