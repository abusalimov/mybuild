...
so-called predicate graph whose nodes represent variables in question. A node,
in turn, consists of two literals: one for the node taking the False value, and
one for True. Graph edges are defined between these litelals and represent
node relations, e.g. dependencies.
